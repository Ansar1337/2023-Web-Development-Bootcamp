...
// Prepend methods adds the html elements inside the queried element but before all the contents
$('h1').prepend('<button>Prepend</button>')
// Similarly with append but after the contents inside the queried tag
